...
class RoomTypesControllerTest < ActionController::TestCase
  ...
  test "should create room_type" do
    assert_difference('RoomType.count') do
      post :create, room_type: { description: @room_type.description, max_capacity: @room_type.max_capacity, price: @room_type.price }
    end
  ...
  test "should update room_type" do
    patch :update, id: @room_type, room_type: { description: @room_type.description, max_capacity: @room_type.max_capacity, price: @room_type.price }
    assert_redirected_to room_type_path(assigns(:room_type))
  end
